...
CREATE TABLE XE( MAXE NVARCHAR(50) PRIMARY KEY(MAXE), TENXE NVARCHAR(100),NHASANXUAT NVARCHAR(100), SOLUONG INT,THONGTINBAOHANH NVARCHAR(100),GIA INT,MOTA NVARCHAR(200));
 ...
 --- NHAP LIEU---
 INSERT INTO XE (MAXE,TENXE,NHASANXUAT,SOLUONG,THONGTINBAOHANH,GIA,MOTA) VALUES ('EX','Exciter','Yamaha',10,'3 nam',1000000,'xe trom cho');
 INSERT INTO XE (MAXE,TENXE,NHASANXUAT,SOLUONG,THONGTINBAOHANH,GIA,MOTA) VALUES ('SR','Sirius','Yamaha',20,'1 nam',1500000,'xe FA');


 INSERT INTO KHACHHANG(MAKH,TENKH,DIACHI,SDT) VALUES ('KH01','Tai','Tp.HCM','cc ba m');
 ---TAO KHOA NGOAI---
